...
void sub(int arr1[],int arr2[],int n1,int n2)                            //function for adding numbers from two files.
{
...
void subparallel(int arr1[],int arr2[],int n1,int n2)                               //function to parallely fetch numbers from files and add.
{
fstream out ,out1 ,out2;
int arr3[10000];
...
Time in sequential is 0.0318949
Time in parallel is 0.0556065
Speed up 0.573581
*/